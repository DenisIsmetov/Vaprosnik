  <!--Главният модула с динамично съдържание на системата-->  
<?php
...
//Изключване на теста и задаване на кла
...
if (isset($_SESSION['key'])) {
    if (@$_GET['deidquiz'] && $_SESSION['key'] == '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
        ...
        if (isset($_POST['vip'])) {
            $chas   = $_POST['chas'];
            $rol    = mysqli_query($con, "UPDATE quiz SET class='$chas' WHERE eid='$eid'");
        }
...
if (isset($_SESSION['key'])) {
    if (@$_GET['q'] == '7' && $_SESSION['key'] == '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
        ob_start();
        $mmm = $_POST['class'];
        $teach = $_POST['teachclass'];
        $qop  = mysqli_query($con, "INSERT INTO class VALUES (NULL,'$mmm', '$teach')");
    header("location:dash.php?q=7");
    }
} 
 
//Включване на теста и задаване на клас
...
//Премахване на клас от графика

if (isset($_SESSION['key'])) {
    if (@$_GET['dugraph'] && @$_GET['nametest'] && @$_GET['data'] && $_SESSION['key'] == '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
        $dugraph = @$_GET['dugraph'];
        $nametest = @$_GET['nametest'];
        $data = @$_GET['data'];
        $r56 = mysqli_query($con, "DELETE FROM graph WHERE clase='$dugraph' AND nametest='$nametest' AND data ='$data'") or die('Error25');
...
if (isset($_SESSION['key'])) {
    if (@$_GET['duserclass'] && $_SESSION['key'] == '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
        $duserclass = @$_GET['duserclass'];
        $r8 = mysqli_query($con, "DELETE FROM class WHERE class='$duserclass'") or die('Error');
        header("location:dash.php?q=7");
    }
}
if (isset($_SESSION['key'])) {
...
//Добавяне на тест към системата
...
if (isset($_SESSION['key'])) {
    if (@$_GET['q'] == 'addquiz' && $_SESSION['key'] == '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
        ...
        $status  = "disabled";
        $id      = uniqid($_GET['id']);
        $q3      = mysqli_query($con, "INSERT INTO quiz VALUES(NULL,'$id','$name','$correct','$wrong','$total','$time', 'NOW()','$status', 0, '$ot6', '$do6', '$ot5', '$do5', '$ot4', '$do4', '$ot3', '$do3', '$ot2', '$do2')");
        header("location:dash.php?q=4&step=2&eid=$id&n=$total");
    }
}


//Добавяне на тестове в графика

if (isset($_SESSION['key'])) {
    if (@$_GET['q'] == 'graph' && $_SESSION['key'] == '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
        $namechas    = $_POST['namechas'];
        $nametest    = $_POST['nametest'];
        $clase       = $_POST['clase'];
        $data        = $_POST['data'];
        $q39         = mysqli_query($con, "INSERT INTO graph VALUES  (NULL, '$nametest' , '$clase' , '$data' , '$namechas' )");
        header("location:dash.php?q=8");
        ob_get_contents();
    }
}

//Добавяне на въпроси и отговори към системата
...
if (isset($_SESSION['key'])) {
    if (@$_GET['q'] == 'addqns' && $_SESSION['key'] == '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
        ...
        for ($i = 1; $i <= $n; $i++) {
            ...
            $qc = mysqli_query($con, "INSERT INTO options VALUES  (NULL,'$qid','$c','$ocid')") or die('Error63');
            $qd = mysqli_query($con, "INSERT INTO options VALUES  (NULL,'$qid','$d','$odid')") or die('Error64');

            $e = addslashes($_POST['ans' . $i]);
